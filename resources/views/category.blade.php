        ...
        <div class="row theme-product">
            ...
            <div class="col-lg-3 text-center  mb-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="card-title text-center"><a href="#" class="text-dark text-decoration-none">₹ 799.00</a></h6>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 text-center  mb-4">
            ...
            <div class="col-lg-3 text-center mb-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center"><a href="#" class="text-dark text-decoration-none">Camera</a></h5>
            ...
            <div class="col-lg-3 text-center mb-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center"><a href="#" class="text-dark text-decoration-none">Hand Bag</a></h5>
                        <h6 class="card-title text-center">₹ 599.00</h6>
                    </div>
                </div>
            </div>
