                    ...
                    <table id="example" class="display">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>₹ 599.00</td>
                                <td><a href="" class="btn btn-sm bg-danger text-light">Delivered</a></td>


                                <td>
                                    <a href="" class="btn btn-sm bg-primary text-light"><i class="fa-solid fa-truck"></i></a>
                                    <a href="" class="btn btn-sm bg-success text-light "><i class="fa-solid fa-check"></i></a>
                                    <a href="#" class="btn btn-sm bg-danger text-light"><i class="fa-solid fa-ban"></i></a>
                            ...
                            <tr>
                                ...
                                <td>₹ 599.00</td>
                                <td><a href="" class="btn btn-sm bg-warning text-light">Delivered</a></td>
