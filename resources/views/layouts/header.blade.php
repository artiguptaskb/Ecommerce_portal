    ...
    <nav class="navbar navbar-expand-lg theme-navbar">
        <div class="container">
            <a class="navbar-brand" href="{{url('/')}}">
                <img src="{{asset('assets/images/logo/logo.png')}}" class="card-img-top" alt="..." style="width: 250px;">
            </a>
            ...
            <div>
                <form class="d-flex" role="search">
                    <div class="input-group">
                        ...
                        <button class="btn btn-sm btn-light text-secondary" type="submit"><i class="fa-solid fa-magnifying-glass"></i></button>
                    </div>
                </form>
            </div>
            <div>
                <a href="#" class="text-decoration-none text-light">Become a Seller</a>
                <a href="{{url('/cart-list/product')}}" class="btn theme-green-btn  text-light rounded-pill btn-sm py-2 px-3"> <i class="fa-solid fa-cart-shopping "></i> Cart</a>
                <a href="{{url('login')}}" class="btn theme-orange-btn text-light rounded-pill btn-sm  py-2 px-3"> <i class="fa-solid fa-user"></i> Login</a>
            </div>
        </div>
    </nav>
    <!-- Category Nav -->

    <nav class="navbar navbar-expand-lg shadow p-3 bg-body-tertiary">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{url('category/electronics/tv')}}">Bad</a></li>
                            <li><a class="dropdown-item" href="#">Sofaa</a></li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-dark" href="{{url('category/electronics/tv')}}" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Applinces
                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{url('category/electronics/tv')}}">TV</a></li>
                            <li><a class="dropdown-item" href="#">Washing Machhine</a></li>
                            <li><a class="dropdown-item" href="#">Refrigeratorss</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
